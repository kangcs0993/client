...
export default function ProfileInfo({
    ...
    const signOutButton = (
        <button className="ml-2 bg-gray-200 px-4 py-2 text-sm font-semibold rounded-lg"
    ...
    const followButton = (
        <button className="ml-2 bg-blue-500 text-white text-sm px-4 py-2 font-semibold p-2 rounded-lg"
    ...
    const unfollowButton = (
        <button className="ml-2 bg-gray-200 text-sm px-4 py-2 font-semibold p-2 rounded-lg"
